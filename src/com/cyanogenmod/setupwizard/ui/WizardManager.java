...
import com.cyanogenmod.setupwizard.setup.WizardAction;
import com.cyanogenmod.setupwizard.setup.WizardScript;
...
public class WizardManager extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            int resultCode = intent.getIntExtra("com.android.setupwizard.ResultCode", 0);
    ...
    private void doAction(String scriptUri, WizardAction action, Intent extras) {
        ...
        Log.i(TAG, "doAction action=" + action);
        if(LOGV) {
            Log.v(TAG, "doAction scriptUri=" + scriptUri + " extras=" + extras
                    + " intent=" + intent + " extras2=" + intent.getExtras());
        }
        ...
        SetupWizardUtils.setLastActionId(this, action.getId());
    ...
    private void next(String scriptUri, String actionId, int resultCode, Intent extras) {
        Log.i(TAG, "next actionId=" + actionId + " resultCode=" + resultCode);
...
//        ComponentHelper.disableComponent(((Context)this), this.getClass());
    }
