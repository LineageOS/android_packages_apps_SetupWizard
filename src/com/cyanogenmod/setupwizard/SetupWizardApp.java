...
public class SetupWizardApp extends Application {
    ...
    private void disableComponentsForMissingFeatures() {
        ...
        if (!SetupWizardUtils.hasFingerprint(this)) {
            SetupWizardUtils.disableComponent(this, FingerprintActivity.class);
        }
        if (!SetupWizardUtils.hasTelephony(this)) {
            SetupWizardUtils.disableComponent(this, MobileDataActivity.class);
            SetupWizardUtils.disableComponent(this, SimMissingActivity.class);
        ...
        if (!SetupWizardUtils.hasWifi(this)) {
            SetupWizardUtils.disableComponent(this, WifiSetupActivity.class);
        }
    }
}
