...
public class FingerprintSetupPage extends SetupPage {
    ...
    private static final int REQUEST_ENROLL_FINGERPRINT = 1000;
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        if (REQUEST_ENROLL_FINGERPRINT == requestCode) {
    ...
    public static class FingerprintSetupFragment extends SetupPageFragment {
        ...
        private void launchFingerprintSetup() {
            ...
            SetupStats.addEvent(SetupStats.Categories.EXTERNAL_PAGE_LOAD,
                    ...
                    SetupStats.Label.PAGE,  SetupStats.Label.LOCK_SCREEN_SETUP);
            startActivityForResult(intent, REQUEST_ENROLL_FINGERPRINT, options.toBundle());
        }
    }
}
