...
public class SetupWizardUtils {
    ...
    public static void startSetupWizardExitProcedure(Context context) {
        try {
            ...
            // The exit worker disables components at the end, including the WorkManager component
            // required here, so this is likely an error finding that component, and we can assume
            // the worker has already run and does not need to run again.
