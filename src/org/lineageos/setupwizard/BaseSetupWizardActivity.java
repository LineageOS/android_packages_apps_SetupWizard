...
public abstract class BaseSetupWizardActivity extends Activity
        implements NavigationBarListener, ViewTreeObserver.OnPreDrawListener {
    ...
    public void setBackAllowed(boolean allowed) {
        ...
        mIsBackAllowed = allowed;
    }

    protected boolean isBackAllowed() {
        return mIsBackAllowed;
    }
    ...
    protected void hideNextButton() {
        if (mNavigationBar != null) {
            ...
            mNavigationBar.getNextButton().startAnimation(fadeOut);
            mNavigationBar.getNextButton().setVisibility(INVISIBLE);
        }
    }
