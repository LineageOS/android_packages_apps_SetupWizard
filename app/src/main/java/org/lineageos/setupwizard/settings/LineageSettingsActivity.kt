...
class LineageSettingsActivity : BaseSetupWizardActivity() {
    ...
    override fun getLayoutResId() = R.layout.setup_lineage_settings

    override fun getTitleResId() = R.string.setup_services

    override fun getIconResId() = R.drawable.ic_features
