...
class NavigationSettingsActivity : BaseSetupWizardActivity() {
    ...
    override fun getLayoutResId() = R.layout.setup_navigation

    override fun getTitleResId() = R.string.setup_navigation

    override fun getIconResId() = R.drawable.ic_navigation
}
