...
class DateTimeActivity :
    ...
    private lateinit var mCurrentTimeZone: TimeZone
    ...
    override fun getLayoutResId() = R.layout.setup_datetime_page

    override fun getTitleResId() = R.string.setup_datetime

    override fun getIconResId() = R.drawable.ic_datetime
