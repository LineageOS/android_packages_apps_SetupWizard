...
class DateTimeActivity :
    ...
    private lateinit var currentTimeZone: TimeZone
    ...
    override val layoutResId = R.layout.setup_datetime_page

    override val titleResId = R.string.setup_datetime

    override val iconResId = R.drawable.ic_datetime
