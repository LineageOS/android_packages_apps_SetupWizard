    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when {
            ...
            SetupWizardUtils.isManagedProfile(this) ->
                wizardBundle.putString(EXTRA_SCRIPT_URI, getString(R.string.lineage_wizard_script_managed_profile_uri))
            else ->
                wizardBundle.putString(EXTRA_SCRIPT_URI, getString(R.string.lineage_wizard_script_user_uri))
        }
