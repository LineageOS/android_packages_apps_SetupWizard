...
class LocationSettingsActivity : BaseSetupWizardActivity() {
    ...
    override fun getLayoutResId() = R.layout.location_settings

    override fun getTitleResId() = R.string.setup_location

    override fun getIconResId() = R.drawable.ic_location
}
