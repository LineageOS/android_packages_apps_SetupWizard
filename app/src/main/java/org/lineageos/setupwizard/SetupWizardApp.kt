...
class SetupWizardApp : Application() {
    ...
    private val ignoreSimLocale = SystemProperties.getBoolean(IGNORE_SIM_LOCALE_PROP, false)
    ...
    companion object {
        ...
        const val UPDATE_RECOVERY_PROP = "ro.setupwizard.ignore_sim_locale"
        ...
        @Volatile
        @JvmField
        var isRadioReady: Boolean = false
